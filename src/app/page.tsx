  ...
  return (
    <main className="relative w-full min-h-screen flex flex-col items-center overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 w-full p-8 md:px-16 flex justify-between items-center z-50 mix-blend-difference pointer-events-none">
        ...
        <div className="hidden md:flex gap-8 font-mono text-sm text-text-secondary pointer-events-auto">
      ...
      <section className="relative w-full h-screen flex flex-col justify-center px-8 md:px-16 lg:px-24 max-w-[1440px]">
        <motion.div variants={containerVariants} initial="hidden" animate="show" className="z-10 mix-blend-difference pointer-events-none">
          ...
          <div className="overflow-hidden"><motion.h1 variants={textVariants} className="font-display text-5xl md:text-8xl lg:text-[10rem] font-bold tracking-tighter leading-[0.85] text-text-secondary">UNUSUALLY</motion.h1></div>
          ...
          <div className="overflow-hidden flex items-center gap-4 md:gap-8 mt-2"><motion.h1 variants={textVariants} className="font-display text-5xl md:text-8xl lg:text-[10rem] font-bold tracking-tighter leading-[0.85] text-accent-primary">EXPERIENCES.</motion.h1></div>
          
          <div className="mt-16 md:mt-24 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-24 pointer-events-auto">
            <motion.div variants={textVariants} className="font-mono text-xs md:text-sm text-text-secondary uppercase tracking-widest max-w-sm">
            ...
            <motion.div variants={textVariants} className="flex gap-6 items-start">
              <a href="#work" className="px-8 py-4 border border-border text-text-primary rounded-full hover:border-text-primary hover:bg-text-primary hover:text-bg-primary transition-all duration-500 font-sans text-sm font-medium" data-hoverable>View Work</a>
              <a href="#contact" className="px-8 py-4 bg-accent-primary text-bg-primary rounded-full hover:opacity-80 transition-all duration-500 font-sans text-sm font-medium" data-hoverable>Let's Talk</a>
            </motion.div>
          </div>
        </motion.div>
      </section>
      ...
      {/* Intro / About */}
      <section id="about" className="w-full bg-bg-base flex flex-col justify-center px-8 md:px-16 lg:px-24 py-32 md:py-48 z-10">
      ...
      {/* Capabilities */}
      <section className="w-full bg-bg-secondary flex flex-col justify-center px-8 md:px-16 lg:px-24 py-32 md:py-48 z-10 border-t border-border">
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col gap-12">
              <div className="group border-b border-border pb-8 hover:border-accent transition-colors duration-500">
      ...
      {/* Selected Work */}
      <section id="work" className="w-full bg-bg-base flex flex-col justify-center px-8 md:px-16 lg:px-24 py-32 md:py-48 z-10 border-t border-border">
        <div className="max-w-[1440px] w-full mx-auto">
      ...
      {/* Experience Timeline */}
      <section id="experience" className="w-full bg-bg-secondary flex flex-col justify-center px-8 md:px-16 lg:px-24 py-32 md:py-48 z-10 border-t border-border">
        <div className="max-w-[1440px] w-full mx-auto">
      ...
      {/* Contact */}
      <section id="contact" className="w-full bg-bg-base flex flex-col justify-center px-8 md:px-16 lg:px-24 py-32 md:py-48 z-10 border-t border-border">
      ...
      <footer className="w-full py-8 px-8 md:px-16 lg:px-24 border-t border-border bg-bg-secondary flex justify-between items-center text-xs font-mono text-text-secondary z-10">
